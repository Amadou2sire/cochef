          ...
          <div className="bg-blue-300 p-8 md:p-12 lg:px-16 lg:py-24">
            <div className="mx-auto max-w-xl text-center">
              <h2 className="text-2xl font-bold text-white md:text-3xl">
                Présentation rapide de la startup
              </h2>

              <p className="hidden text-white/90 sm:mt-4 sm:block">
               Texte court présentant la philosophie, les valeurs, et ce qui rend Cochef unique (qualité, fraîcheur, chef expert)Photo ou illustration de l’équipe ou du restaurant
              </p>
